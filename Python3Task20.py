...
Scrabble_word = input("Введите слово: ")
word_list = list(Scrabble_word.upper())
word_sum = 0
for i in word_list:
    word_sum += dictionary[i]

print("Стоимость слова ", Scrabble_word, "равна ", word_sum)
